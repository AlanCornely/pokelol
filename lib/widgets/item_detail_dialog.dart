                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  if (item.sellPrice > 0) ...[
                                    const SizedBox(width: 16),
                                    Icon(Icons.sell, color: const Color(0xFFA09B8C), size: 16),
                                    const SizedBox(width: 4),
                                    Text(
                                      '${item.sellPrice}',
                                      style: const TextStyle(
                    ...
                    if (item.from.isNotEmpty || item.into.isNotEmpty) ...[
                      ...
                      if (item.from.isNotEmpty)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Construído a partir de:', style: const TextStyle(color: Color(0xFFA09B8C), fontSize: 12)),
                      ...
                      if (item.into.isNotEmpty)
                        Column(
                          ...
                          children: [
                            const SizedBox(height: 8),
                            Text('Usado para construir:', style: const TextStyle(color: Color(0xFFA09B8C), fontSize: 12)),
                            const SizedBox(height: 4),
                            Wrap(
                              spacing: 8,
